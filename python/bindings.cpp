...
PYBIND11_MODULE(pydmc_route, m) {
    ...
    py::class_<Reach>(m, "Reach", "River reach segment")
        ...
        // Gradients (read-only)
        .def_property_readonly("grad_manning_n", &Reach::grad_manning_n,
            "Gradient w.r.t. Manning's n")
        .def_property_readonly("grad_width_coef", &Reach::grad_width_coef,
            "Gradient w.r.t. width coefficient")
        .def_property_readonly("grad_width_exp", &Reach::grad_width_exp,
            "Gradient w.r.t. width exponent")
        .def_property_readonly("grad_depth_coef", &Reach::grad_depth_coef,
            "Gradient w.r.t. depth coefficient")
        .def_property_readonly("grad_depth_exp", &Reach::grad_depth_exp,
    ...
    py::class_<DiffusiveWaveIFT>(m, "DiffusiveWaveIFT",
        ...
        .def("set_lateral_inflow", &DiffusiveWaveIFT::set_lateral_inflow,
            py::arg("reach_id"), py::arg("inflow"))
        .def("set_lateral_inflows", &DiffusiveWaveIFT::set_lateral_inflows,
            py::arg("inflows"))
        .def("get_discharge", &DiffusiveWaveIFT::get_discharge, py::arg("reach_id"))
        .def("get_all_discharges", &DiffusiveWaveIFT::get_all_discharges)
    ...
    py::class_<SoftGatedKWT>(m, "SoftGatedKWT",
        ...
        .def("set_lateral_inflow", &SoftGatedKWT::set_lateral_inflow,
            py::arg("reach_id"), py::arg("inflow"))
        .def("set_lateral_inflows", &SoftGatedKWT::set_lateral_inflows,
            py::arg("inflows"))
